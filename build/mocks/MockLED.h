...
#define LED_Toggle_Expect(num) LED_Toggle_CMockExpect(__LINE__, num)
...
#define LED_Off_Expect(num) LED_Off_CMockExpect(__LINE__, num)
...
#define LED_On_Expect(num) LED_On_CMockExpect(__LINE__, num)
